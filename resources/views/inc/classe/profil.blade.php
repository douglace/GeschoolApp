                    ...
                    <div class="row" style="display: flex; align-items: center;">
                        <div class="col-lg-10 col-md-10 col-sm-6 col-xs-6">
                            <h2 style="text-transform: uppercase;">
                                LISTE DES ELEVES DE LA CLASSE DE {{$classe->intitule}} | EFFECTIF: {{count(App\Inscription::getAllEleve($annee_id, $classe->classe_id))}} | 
                                TITULAIRE: <a title="Profile" href="{{route('front.enseignant.profil', [$classe->titulaire->enseignant_id ?? 0])}}" target="_blank" class="link">{{$classe->titulaire->getFullName() ?? ""}}</a>
                            </h2>
                        </div>
