...
@section('content')
    ...
    <!-- #END# Basic Examples -->
    <!-- Modal add -->
    @include("inc.trimestre.add")
    <!-- #END# Modal add -->
    @include("inc.trimestre.edit")
    <!-- Modal edit -->
...
@section('script')
    <script type="text/javascript">
        ...
        var show = function () {
            ...
            $.ajax({
                url: "{{route('front.trimestre.index')}}",
        ...
        var add = function (form_data) {
            $.ajax({
                url: "{{route("front.trimestre.creat")}}",
                type: 'POST',
                data: form_data,
                success: function (data) {
                    if (data.status == true) {
        ...
        var update = function (form_data) {
            $.ajax({
                url: "{{route("front.trimestre.update")}}",
                type: 'POST',
                data: form_data,
                success: function (data) {
                    if (data.status == true) {
