...
@section('content')
    ...
    @include("inc.groupe_matiere.edit")
    <!-- Modal edit -->
...
@section('script')
    <script type="text/javascript">
        ...
        var show = function() {
            ...
            $.ajax({
                url: "{{ route('front.groupe_matiere.index') }}",
        ...
        var add = function(form_data) {
            $.ajax({
                url: "{{ route('front.groupe_matiere.creat') }}",
                type: 'POST',
                data: form_data,
                success: function(data) {
                    if (data.status == true) {
        ...
        var update = function(form_data) {
            $.ajax({
                url: "{{ route('front.groupe_matiere.update') }}",
                type: 'POST',
                data: form_data,
                success: function(data) {
                    if (data.status == true) {
