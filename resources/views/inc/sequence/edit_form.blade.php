        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" name="intitule" class="form-control" value="{{ $sequence->intitule }}"
                            required>
            ...
            <div class="col-sm-6">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="number" name="numero" class="form-control" value="{{ $sequence->numero }}"
                            required min="1">
                    ...
                    @foreach ($trimestres as $trimestre)
                        @if ($trimestre->etat == 1)
                            @if ($trimestre->trimestre_id == $sequence->trimestre->trimestre_id)
                                <option value="{{ $trimestre->trimestre_id }}" selected>{{ $trimestre->intitule }}
                                </option>
                            @else
