        ...
        @foreach ($users as $user)
            <tr>
                ...
                <td>
                    ...
                    <a title="Edité" href="{{route('front.users.edit', [$user->id])}}" id="edit" style="cursor: pointer;" class="link"><i
                            class="material-icons">edit</i></a>
                    <a title="Supprimé" id="delete" style="cursor: pointer;" onclick="showConfirmMessage('{{route('front.users.delete', [$user->id])}}')" class="link"><i
