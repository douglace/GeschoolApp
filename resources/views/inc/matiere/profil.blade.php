                    ...
                    <div class="row" style="display: flex; align-items: center;">
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-6">
                            <h2 style="text-transform: uppercase;">
                                ...
                                TITULAIRE: <a title="Profile" href="{{route('front.enseignant.profil', [$matiere->responsable->enseignant_id ?? 0])}}" target="_blank" class="link">{{$matiere->responsable->getFullName() ?? ""}}</a>
                            </h2>
                        </div>
